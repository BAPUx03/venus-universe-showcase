...
export const Route = createFileRoute("/")({
  ...
  head: ({ loaderData }) => {
    ...
    const realEstateSchema = {
      ...
      alternateName: ["Venus Universe", "Venus Universe Ahmedabad", "Venus Universe Nehrunagar Ahmedabad"],
      url: siteUrl,
      image: seo.ogImage,
      logo: seo.ogImage,
      description: "Venus Universe Nehrunagar — luxury 4 BHK & 5 BHK apartments in Nehrunagar, Ahmedabad. Pre-booking open.",
